...
> Fonte única, machine-readable (`scripts/gate.py` faz parse). Não altere a estrutura dos
> blocos. Regras em `.claude/rules/fontes-e-citacoes.md`.
>
> **`origem` é obrigatório** — diz como sabemos que a referência existe. Entrada sem
> origem verificável é tratada como inventada e bloqueia o gate.
>
> Chave = `[Sobrenome, Ano]` (NBR 10520/2023 — sem caixa alta na citação).
>
> ⚠️ Estas são as referências dos **dois relatórios de estágio**, fornecidas pelo autor em
> 27/07/2026. Servem de base, mas **não bastam** para o referencial — ver lacunas ao final.
...
- **titulo:** Django documentation
- **veiculo:** documentação oficial, versão 4.2
- **ano:** 2026
- **doi_url:** https://docs.djangoproject.com/en/4.2/
- **acesso_em:** 03 fev. 2026
- **origem:** referência dos relatórios de estágio, fornecida pelo autor em 27/07/2026
...
- **veiculo:** 7. ed. Rio de Janeiro: Pearson
- **ano:** 2018
- **origem:** referência dos relatórios de estágio, fornecida pelo autor em 27/07/2026
...
- **tipo:** documentacao
- **autores:** EMBRAPII
- **titulo:** Manual do Programa Capacitação 4.0
- **veiculo:** v. 1.0. Brasília: Empresa Brasileira de Pesquisa e Inovação Industrial
- **ano:** 2021
- **origem:** referência dos relatórios de estágio; cópia em `docs/Manual-EMBRAPII-Capacitação-4.0.pdf`

## [Fielding, 2000]
- **tipo:** tese
- **autores:** FIELDING, Roy Thomas
- **titulo:** Architectural styles and the design of network-based software architectures
- **veiculo:** Tese (Doutorado em Informação e Ciência da Computação) – University of California, Irvine
- **ano:** 2000
- **origem:** referência dos relatórios de estágio, fornecida pelo autor em 27/07/2026

## [Groover, 2010]
- **tipo:** livro
- **autores:** GROOVER, Mikell P.
- **titulo:** Automação industrial e sistemas de manufatura
- **veiculo:** 3. ed. São Paulo: Pearson Prentice Hall
- **ano:** 2010
- **origem:** referência dos relatórios de estágio, fornecida pelo autor em 27/07/2026
...
- **tipo:** artigo
- **autores:** MERKEL, Dirk
- **titulo:** Docker: lightweight Linux containers for consistent development and deployment
...
- **tipo:** documentacao
- **autores:** N8N
- **titulo:** n8n documentation
- **veiculo:** documentação oficial
- **ano:** 2025
- **doi_url:** https://docs.n8n.io
...
## [Sobrenome, Ano]
- **tipo:** artigo | livro | capitulo | tese | dissertacao | anais | site | documentacao | norma
